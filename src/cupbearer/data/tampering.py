...
from cupbearer.utils.utils import PathConfigMixin
...
class TamperingDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return (sample["text"], torch.tensor([*sample["measurements"], 
...
class TamperingDataConfig(DatasetConfig):
    ...
    def _build(self) -> TamperingDataset: #TODO: allow for local loading / saving
        name = TAMPERING_DATSETS[name] if name in TAMPERING_DATSETS else name
